Public Class CSV作成
    ...
    '保存ファイル名定型部
    Private Const DEFAULT_SAVE_NAME As String = "勤務割"
    ...
    Private Sub btnExecution_Click(sender As System.Object, e As System.EventArgs) Handles btnExecution.Click
        ...
        If Me.saveCsvFileDialog.ShowDialog = Windows.Forms.DialogResult.OK Then
            ...
            '常勤部分
            Dim sql = "SELECT * FROM KinD WHERE YM='" & ymStr & "' AND Rdr<>'' AND ((Seq2='00' AND Unt='※') OR ('20' <= Seq2 AND Seq2 <= '39')) order by Rdr, Seq, Seq2 DESC"
